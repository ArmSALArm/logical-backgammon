...
function AbstractRule() {
  if (this.constructor === AbstractRule) {
 ...
 */
AbstractRule.prototype.initialize = function(state) {
 ...
 */
AbstractRule.prototype.rollDice = function(game, values) {
 ...
 */
AbstractRule.prototype.resetState = function(state) {
 ...
 */
AbstractRule.prototype.incPos = function(position, type, steps) {
  throw new Error("Abstract method!");
};
 ...
 */
AbstractRule.prototype.normPos = function(position, type) {
  throw new Error("Abstract method!");
};
 ...
 */
AbstractRule.prototype.denormPos = function(position, type) {
  throw new Error("Abstract method!");
};
 ...
 */
AbstractRule.prototype.havePiecesOnBar = function(state, type) {
 ...
 */
AbstractRule.prototype.countAtHigherPos = function(state, position, type) {
  var cnt = 0;
 ...
 */
AbstractRule.prototype.allPiecesAreHome = function(state, type) {
 ...
 */
AbstractRule.prototype.validateTurn = function(game, player) {
  if (!game.hasStarted) {
 ...
 * @returns {boolean} True if move is valid and should be allowed.
 */
AbstractRule.prototype.validateMove = function(game, player, piece, steps) {
 ...
 */
AbstractRule.prototype.validateConfirm = function(game, player) {
  if (!this.validateTurn(game, player)) {
    return false;
  }
 ...
 * @returns {boolean} True if confirmation is allowed
 */
AbstractRule.prototype.validateUndo = function(game, player) {
  if (!this.validateTurn(game, player)) {
    return false;
  }
 ...
 */
AbstractRule.prototype.calculateMoveWeights = function(state, movesLeft, pieceType, rootPiece, stopAtMax) {
  var weight = {};
  weight.max = 0;
 ...
 */
AbstractRule.prototype.isMoveActionRestricted = function(state, movesLeft, piece, steps) {
  // 1. Try out all possible moves (for all of player's pieces).
  // 2. Sum the move values for all resulting branches with possible moves.
  // 3. Check if the move request of the player can be used in a branch that allows
  //    all move values to be used.
 ...
 */
AbstractRule.prototype.getMoveActions = function(state, piece, steps) {
  throw new Error("Abstract method!");
};
 ...
 */
AbstractRule.prototype.applyMoveActions = function(state, actionList) {
 ...
 */
AbstractRule.prototype.place = function (state, number, type, position) {
 ...
 */
AbstractRule.prototype.move = function(state, piece, toPos) {
 ...
 * @throws Throws an error if there is no piece at fromPos or piece is of wrong type
 */
AbstractRule.prototype.bear = function (state, piece) {
  // Find the current position of the piece
  var fromPos = model.State.getPiecePos(state, piece);
 ...
 * @throws Throws an error if there is no piece at fromPos or piece is of wrong type
 */
AbstractRule.prototype.hit = function (state, piece) {
  // Find the current position of the piece
  var fromPos = model.State.getPiecePos(state, piece);
 ...
 * @throws Throws an error if there is no piece at fromPos or piece is of wrong type
 */
AbstractRule.prototype.recover = function (state, piece, position) {
 ...
 */
AbstractRule.prototype.markAsPlayed = function (game, move) {
 ...
 */
AbstractRule.prototype.hasWon = function (state, player) {
  console.log('hasWon');
 ...
 * @returns {boolean} - True if player has won the game
 */
AbstractRule.prototype.getGameScore = function (state, player) {
 ...
 */
AbstractRule.prototype.nextTurn = function (match) {
