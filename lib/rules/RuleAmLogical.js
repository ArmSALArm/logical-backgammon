 ...
 * @extends Rule
 */
function RuleAmLogical() {
    Rule.call(this);

    /**
     * Rule name, matching the class name (eg. 'RuleAmLogical')
     * @type {string}
     */
    this.name = 'RuleAmLogical';
     ...
     * @type {string}
     */
    this.description = 'First Logical Backgammon.';
...
RuleAmLogical.prototype = Object.create(Rule.prototype);
RuleAmLogical.prototype.constructor = RuleAmLogical;
 ...
 */
RuleAmLogical.prototype.rollDice = function(game, values) {
 ...
 */
RuleAmLogical.prototype.resetState = function(state) {
    /**
 ...
 */
RuleAmLogical.prototype.incPos = function(position, type, steps) {
    var newPosition;
 ...
 */
RuleAmLogical.prototype.normPos = function(position, type) {
 ...
 */
RuleAmLogical.prototype.denormPos = function(position, type) {
 ...
 */
RuleAmLogical.prototype.getMoveActions = function(state, piece, steps) {
    var actionList = [];
     ...
     *
     * @alias RuleAmLogical.getMoveActions.addAction
     * @memberof RuleAmLogical.getMoveActions
     * @method RuleAmLogical.getMoveActions.addAction
 ...
 */
RuleAmLogical.prototype.markAsPlayed = function (game, move) {
 ...
 */
RuleAmLogical.prototype.nextTurn = function (match) {
...
module.exports = new RuleAmLogical();