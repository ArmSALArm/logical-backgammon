 ...
 * @extends Rule
 */
function LongBackgammon() {
    Rule.call(this);

    /**
     * Rule name, matching the class name (eg. 'LongBackgammon')
     * @type {string}
     */
    this.name = 'LongBackgammon';
...
LongBackgammon.prototype = Object.create(Rule.prototype);
LongBackgammon.prototype.constructor = LongBackgammon;
 ...
 */
LongBackgammon.prototype.rollDice = function(game, values) {
 ...
 */
LongBackgammon.prototype.resetState = function(state) {
    /**
 ...
 */
LongBackgammon.prototype.incPos = function(position, type, steps) {
    var newPosition;
 ...
 */
LongBackgammon.prototype.normPos = function(position, type) {
 ...
 */
LongBackgammon.prototype.denormPos = function(position, type) {
 ...
 */
LongBackgammon.prototype.getMoveActions = function(state, piece, steps) {
    var actionList = [];
     ...
     *
     * @alias LongBackgammon.getMoveActions.addAction
     * @memberof LongBackgammon.getMoveActions
     * @method LongBackgammon.getMoveActions.addAction
 ...
 */
LongBackgammon.prototype.markAsPlayed = function (game, move) {
 ...
 */
LongBackgammon.prototype.nextTurn = function (match) {
...
module.exports = new LongBackgammon();