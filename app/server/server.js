...
// console.log('WWWWWWSSSSSSAAAAAAA')
// console.log(match.currentGame)
// console.log('WWWWWWSSSSSSAAAAAAA')
// console.log('XXXWWWWWWSSSSSSAAAAAAA')
// console.log(model.State.getPiecePos(match.currentGame.state, params.piece))
// console.log('XXXWWWWWWSSSSSSAAAAAAA')
// console.log('XXXWWWWWWSSSSSSAAAAAAA')
// console.log(params.piece.id)
// console.log('XXXWWWWWWSSSSSSAAAAAAA')
// console.log('ZZZZZZZZZZZXXXWWWWWWSSSSSSAAAAAAA')
// console.log(this.lastTurnNumber)
// console.log(match.currentGame.turnNumber)
// console.log('ZZZZZZZZZZZZXXXWWWWWWSSSSSSAAAAAAA')
        // if its first turn
        // if(match.currentGame.turnNumber === 1 || match.currentGame.turnNumber === 2){
            ...
            // if(rule.isLastTurnOfTheInitialPosition() && (! rule.isAllowedDiceCombinations(match.currentGame.turnDice))){
            // if(! (params.piece.id === 15 || params.piece.id === 30) && (! rule.isAllowedDiceCombinations(match.currentGame.turnDice))){
            //     console.log('TRUEEE');
            //     reply.errorMessage = 'Requested move is not allowed (don\'t can move 2 piece of initial position)!';
            //     return false;
            // }

        if(this.lastTurnNumber !== match.currentGame.turnNumber){
            this.lastIdFromInitPos = null;
        }

        //todo:: CHECK
        if(model.State.getPiecePos(match.currentGame.state, params.piece) === 23 || model.State.getPiecePos(match.currentGame.state, params.piece) === 11){
            if(this.lastIdFromInitPos === null) {
                this.lastIdFromInitPos = params.piece.id;
                this.lastTurnNumber = match.currentGame.turnNumber;
            } else {
                // this.lastIdFromInitPos = null;
                reply.errorMessage = 'Requested move is not allowed (don\'t can move 2 piece of initial position)!';

                if(match.currentGame.turnNumber === 1 || match.currentGame.turnNumber === 2){
                    if((! rule.isAllowedDiceCombinations(match.currentGame.turnDice))){
                        return false;
                    }
                }else{
                    return false;
...
/*console.log(this.lastIdFromInitPos)
        if(model.State.getPiecePos(match.currentGame.state, params.piece) === 23 && this.lastIdFromInitPos !== null){

        }*/

            // if(model.State.getTopPiece(match.currentGame.state, 23)){
            //     console.log('TRUEEE');
            //     return false;
            // }
